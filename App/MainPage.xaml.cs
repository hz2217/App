...
namespace App
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        async void OnShareDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            var photoFile = await StorageFile.GetFileFromApplicationUriAsync(new Uri(ShareItem.Path));
        ...
        private void CheckBox_Checked(object sender, RoutedEventArgs e)
        {
            ...
            //bool isChecked = true;
            if (ViewModel.SelectedItem != null)
                ViewModel.UpdateTodoItem(ViewModel.SelectedItem.Id, ViewModel.SelectedItem.Title, ViewModel.SelectedItem.Description, ViewModel.SelectedItem.Date, ViewModel.SelectedItem.Img, ViewModel.SelectedItem.Path, true);
        }
        private void CheckBox_Unchecked(object sender, RoutedEventArgs e)
        {
            ...
            if (ViewModel.SelectedItem != null)
                ViewModel.UpdateTodoItem(ViewModel.SelectedItem.Id, ViewModel.SelectedItem.Title, ViewModel.SelectedItem.Description, ViewModel.SelectedItem.Date, ViewModel.SelectedItem.Img, ViewModel.SelectedItem.Path, false);
        }
        ...
        private void ClickCreate(object sender, RoutedEventArgs e)
        {
            ...
            if (ViewModel.SelectedItem != null)
            {
                ...
                // 6.3 增加项目时同步到数据库
                AppDatabase.Update(ViewModel.SelectedItem.Id, this.TodoItemTitle2.Text, this.TodoItemDetail.Text, this.Datepicker.Date.DateTime, imgStr);
            }
            else
            {
                Create.Content = "Create";
                ...
                // 6.3 修改项目时同步到数据库
                AppDatabase.Insert(TodoItem.gitIdInstance(), this.TodoItemTitle2.Text, this.TodoItemDetail.Text, this.Datepicker.Date.DateTime, imgStr);
            }
        }
        ...
        private void Delete_Click(object sender, RoutedEventArgs e)
        {
            ...
            // 6.3 删除项目时同步到数据库
            AppDatabase.Delete(ViewModel.SelectedItem.Id);
            ViewModel.SelectedItem = null;
        }

        private void SearchButton_Click(object sender, RoutedEventArgs e)
        {
            string result = AppDatabase.Query(SearchTextBox.Text);
            SearchTextBox.Text = "";
